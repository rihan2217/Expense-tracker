...
function AddExpense() {
  ...
  return (
    <div className=" w-[90vw] max-h-[82vh] lg:w-[50vw] p-4 mb-4  text-white bg-blue-400 dark:text-white dark:bg-blue-950 dark:border-gray-700 border-2 border-blue-400 rounded">
