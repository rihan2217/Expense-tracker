    ...
    <div className=" w-full h-[42%] p-4 mb-2 dark:bg-blue-950 text- dark:text-white dark:border-gray-700 border-2 border-blue-400 bg-white rounded">
        ...
        <div className="flex flex-col items-center gap-2 justify-around p-2 bg-blue-400 dark:bg-blue-950 dark:text-white dark:border-gray-700 border-2 border-blue-400 rounded">
            ...
            <select className="p-2 border-2 text-gray-800 dark:text-gray-500 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              onChange={(e) => Searchexpensebycategory(e.target.value)}>
           ...
           <div className="flex items-center gap-8">
            ...
            <input type="date" placeholder="Search by Date" className="p-2 border-2 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              onChange={(e) => SearchExpensebydate(e.target.value)}/>
